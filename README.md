...
- 📊 **Auto-Generated Visualizations:** Instant charts and glassmorphism-styled UI cards.
- 🧠 **Smart Context:** Understands specific DSP business logic (e.g., editorial placements, BUs).
- ⚡ **Real-time Processing:** Connects directly to Google Sheets for live data analysis.
